package com.anymore.wanandroid.mine.mvp.view.widget
...
class SwipeMenuLayout @JvmOverloads constructor(
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        val ta = context.theme.obtainStyledAttributes(
            attrs,
            R.styleable.wm_SwipeMenuLayout,
            defStyleAttr,
            0
        )
        ...
        for (i in 0 until count) {
            ...
            if (attr == R.styleable.wm_SwipeMenuLayout_swipeEnable) {
                isSwipeEnable = ta.getBoolean(attr, true)
            } else if (attr == R.styleable.wm_SwipeMenuLayout_ios) {
                isIos = ta.getBoolean(attr, true)
            } else if (attr == R.styleable.wm_SwipeMenuLayout_leftSwipe) {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        for (i in 0 until childCount) {
            ...
            if (childView.visibility != View.GONE) {
                ...
                mHeight =
                    Math.max(mHeight, childView.measuredHeight/* + lp.topMargin + lp.bottomMargin*/)
