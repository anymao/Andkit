...
class ClearEditText @JvmOverloads constructor(
    ...
    private var mOnClearTextListener: OnClearTextListener? = null
    ...
    init {
        ...
        if (mClearDrawable == null) {
            ...
            mClearDrawable = ContextCompat.getDrawable(context, R.drawable.ic_search_clear)
        }
    ...
    fun setOnClearTextListenser(onClearTextListener: OnClearTextListener) {
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        if (event.action == MotionEvent.ACTION_UP) {
            if (compoundDrawables[2] != null) {
                ...
                val touchable1 = event.y + top > top && event.y < height


                if (touchable && touchable1) {
                    this.setText("")
